...
$('#mainmodal').bind('click', function(){
	$('#modalform').show();
	$('.modal-content').show();
});

$('#modalform').bind('click', function(){
	$('#modalform').hide();
	$('.modal-content').hide();
});
...
if (width >= 1024) {
	var el = '<video autoplay loop><source src="/wp-content/uploads/2015/09/401797389.mp4" type="video/mp4"></video>';
	$('#video-on-bg').html(el);
}
